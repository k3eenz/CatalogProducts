...
namespace CatalogProd
{
    public partial class MainForm : Form
    {
        ...
        private void LoadManufacturers(ProductDbContext db, string manufacturer = null)
        {
            ...
            ManufacturerComboBox.Items.Add("Âñå ïðîèçâîäèòåëè");
            ...
            if (manufacturer == null || manufacturer == "Âñå ïðîèçâîäèòåëè") 
            {
        ...
        private void PaginateAndDisplayProducts(List<Product> filteredProducts, int totalProductCount)
        {
            ...
            NowPageLabel.Text = $"Ñòðàíèöà {currentPage} èç {totalPages}";
            ...
            CountProducts.Text = $"Ïîêàçàíî {paginatedProducts.Count} èç {totalProductCount}";
